	...
	protected void configure(HttpSecurity http) throws Exception {
	    http
	      ...
	      .antMatcher("/**")  //All requests are protected by default
	        .authorizeRequests()
	           .antMatchers("/", "/login**", "/landingPage**", "/logout.html", "/invalidateSession", "/thumbsignin_widget.css", "/ts/**", "/thumbsign_widget.js","/bootstrap.min.css", "/webjars/**").permitAll()  //The home(index) page, login and ts endpoints are explicitly excluded
